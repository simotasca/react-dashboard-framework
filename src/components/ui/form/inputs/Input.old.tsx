...
export function InputButtons({
  ...
  return <div {...p} className={twJoin(
    "flex w-full",
    "[&_input]:has-[[data-slot=button]]:flex-1",
    "[&_input]:has-[[data-slot=button],[data-slot=control]:last-child]:bg-red-500 [&_input]:has-[[data-slot=button]]:rounded-br-none",
  )} >{children}</div>;
}
